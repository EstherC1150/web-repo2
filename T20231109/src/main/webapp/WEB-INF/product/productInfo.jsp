		...
		<div class="row gx-4 gx-lg-5 align-items-center">
			<div class="col-md-6">
				<img class="card-img-top mb-5 mb-md-0"
					src="resources/images/${vo.prodImage }" alt="${vo.prodCode }이미지" />
			</div>
			<div class="col-md-6">
				<div class="small mb-1">${vo.prodCode }</div>
				<h1 class="display-5 fw-bolder">${vo.prodName }</h1>
				<div class="fs-5 mb-5">
					<span class="text-decoration-line-through">${vo.price }</span> <span>${vo.offPrice }</span>
				</div>
